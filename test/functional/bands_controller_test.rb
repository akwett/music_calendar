...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { genre: @band.genre, location: @band.location, name: @band.name, website: @band.website }
    end
  ...
  test "should update band" do
    put :update, id: @band, band: { genre: @band.genre, location: @band.location, name: @band.name, website: @band.website }
    assert_redirected_to band_path(assigns(:band))
  end
